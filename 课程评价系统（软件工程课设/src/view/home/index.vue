<template>
  <Card :dis-hover="true" class="headerCard">
    <div dis-hover class="map" style="height: 100%;">
      <div class="map-service" :style="{height: height + 'px'}">
        <div class="map-service-right">
          <div class="china-map">
            ...
            <div class="region-list postition-3 active online-node">
              <div class="area-box">
                <span class="dot"></span>
            ...
            <div class="region-list waite postition-5 waite-node" @click="handleChoose5">
              <div class="area-box">
                <span class="dot"></span>
            ...
            <div class="region-list waite postition-8 waite-node">
              <div class="area-box">
                <img style="width: 20px;height:20px" src="../../assets/star.jpg">
              </div>
              <div class="show-regin">
                <span>北京</span>
              </div>
            ...
            <div class="region-list active postition-18 online-node">
              <div class="area-box">
                <span class="dot"></span>
                <span class="pulse delay-04"></span>
                <span class="pulse delay-03"></span>
            ...
            <div class="region-list active postition-19 online-node">
              <div class="area-box">
                <span class="dot"></span>
                <span class="pulse delay-04"></span>
                <span class="pulse delay-03"></span>
            ...
            <div class="region-list active postition-21 online-node">
              <div class="area-box">
                <span class="dot"></span>
                <span class="pulse delay-04"></span>
                <span class="pulse delay-03"></span>
            ...
            <div class="region-list active postition-22 online-node">
              <div class="area-box">
                <span class="dot"></span>
                <span class="pulse delay-04"></span>
                <span class="pulse delay-03"></span>
...
export default {
  ...
  methods: {
    handleChoose5() {
      this.$Message.success("正在进入长沙鼓风机厂");
      this.$router.replace("/monitor/index");
    }
  }
};
</script>
